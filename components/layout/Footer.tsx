    ...
    >
      ...
      >
        <div className="mx-auto max-w-[1280px] px-6 lg:px-12 py-10 flex flex-col md:flex-row md:items-center gap-6 md:gap-12">
          <div className="flex-1 min-w-0">
            ...
            >
              Product, growth, and startup thinking — no noise.
            </p>
          </div>
          <form
          ...
          >
            <input
              ...
              className="flex-1 md:w-64 rounded-lg px-4 py-2.5 text-sm outline-none focus:ring-2"
              style={{
            ...
            <button
              type="submit"
              className="rounded-lg px-5 py-2.5 text-sm font-semibold transition-all duration-150 hover:brightness-110 whitespace-nowrap"
              style={{
      ...
      <div className="mx-auto max-w-[1280px] px-6 lg:px-12 py-14">
        ...
        >
          ...
          <p
            className="text-xs"
            style={{ color: "hsl(210 15% 40%)", fontFamily: "var(--font-body)" }}
          >
            © {new Date().getFullYear()} Rare Phronesis. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
